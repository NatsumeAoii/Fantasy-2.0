...
// ============================================================
// Shared type definitions for consumable item stats.
// Lives in src/types/ so both the data layer and the output
// types layer can reference it without circular dependencies.
// ============================================================
